...
public class CreateJobApi {
	...
	public CreateJobApi(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id, int mst_oem_id,
	...
	public String toString() {
		return "CreateJobApi [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
